...
sq_RunScript("character/atgunner/nitromotor/nitromotor.nut");//Ó¤Ü²õÏòäÐï
...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_AT_GUNNER, "Character/atgunner/atgunner_buff.nut", "atgunner_buff", 17, -1);
...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_AT_GUNNER, "character/atgunner/zhongwuzhuanggaizao/zhongwuzhuanggaizao.nut", "fm31", 26, 38);

IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_AT_GUNNER, "Character/atgunner/overcharge/overcharge.nut", "atovercharge", 252, 252);
 
IRDSQRCharacter.pushState(5, "character/atgunner/alphasupport/alphasupport.nut", "AlphaSupport", 26, -1);
