...
function onStart_appendage_common_burster(appendage)
{
	...
	sq_SetParameterOcularSpectrum(spectrumAppendage, 800, 100, true, sq_RGBA(255, 255, 0, 255), sq_RGBA(255, 255, 0, 0), 2, 2, 2);
	sq_SetParameterOcularSpectrum(spectrumAppendage, 800, 100, true, sq_RGBA(255, 255, 0, 255), sq_RGBA(255, 255, 0, 0), 2, 0, 1);
	///////////////////////	
