ENUM_MAGIC_CANNON_SUBSTATE_CHARGE   <- 0;  // �غ�
ENUM_MAGIC_CANNON_SUBSTATE_HORIZON  <- 1;  // ����(����)
ENUM_MAGIC_CANNON_SUBSTATE_VERTICAL <- 2; // ����(����)
ENUM_MAGIC_CANNON_SUBSTATE_DIAGONAL <- 3; // �밢��(����)
ENUM_MAGIC_CANNON_SUBSTATE_LAND		<- 4; // ���߿� �߰��� ����Ÿ.
...
function onEndCurrentAni_MagicCannon(obj)
{
	...
	else if(subState == ENUM_MAGIC_CANNON_SUBSTATE_CHARGE) {	// ���� �� ���� - �غ� ���� ��
