...
function setCustomData_po_ATFirePillar(obj, reciveData)
{
	...
	local attackRate = reciveData.readDword(); // ���ð��ݷ�
	local distance = reciveData.readDword(); // ������ �Ÿ�
	local arriveTime = reciveData.readDword(); // �ҿ뵹�� ������ �ӵ� (�Ÿ����� �����ϴ� �ð�) (1/1000��)
...
//
	...
	if(passiveState == PASSIVEOBJ_SUB_STATE_0)
	{
		...
		local distance = obj.getVar("dis").get_vector(3); // �� �̵��Ÿ�
