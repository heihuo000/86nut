...
VAR_AMP_IS_GRAB				 <-0 //���� ���� �ִ��� üũ
VAR_AMP_HOLD_REALSE			 <-1 //������ ����
VAR_AMP_HOLD_REALSE_COMPLETE <-2 //���� �Ϸ�
...
function checkCommandEnable_PushOut(obj)
{
	...
	if(state == STATE_ATTACK) {
		...
		return obj.sq_IsCommandEnable(SKILL_PUSH_OUT); // �����忡���� Ư����ų�� ĵ���� �����մϴ�. �۾���:������ [2012.04.20] obj.sq_IsCommandEnable(SKILL_PUSH_OUT);
	}
...
function onProc_PushOut(obj)
{
	...
	for(local i=0;i<objectsSize;++i)
	{
		...
		if(damager)
		{
			...
			if(obj.isCurrentCutomAniIndex(CUSTOM_ANI_PUSH_OUT_GRAB)) { // ��� �ִ� �����϶� ������.					
...
function onSetState_PushOut(obj, state, datas, isResetTimer)
{
	...
	if(subState == ENUM_AMP_SUBSTATE_GRAB) {
		...
		local pushingAttackPower = obj.sq_GetBonusRateWithPassive(SKILL_PUSH_OUT , STATE_PUSH_OUT, 0, 1.0);// �о�� ���ݷ�
