...
function checkCommandEnable_TurnWindmill(obj)
{
	...
	if(state == STATE_ATTACK)
	{
		...
		return obj.sq_IsCommandEnable(SKILL_TURNWINDMILL); // �����忡���� Ư����ų�� ĵ���� �����մϴ�. �۾���:������ [2012.04.20] obj.sq_IsCommandEnable(SKILL_TURNWINDMILL);
	}
...
function onSetState_TurnWindmill(obj, state, datas, isResetTimer)
{
	...
	local attackRate = obj.sq_GetBonusRateWithPassive(SKILL_TURNWINDMILL STATE_TURNWINDMILL, 0, 1.0); //0.���ݷ�(%)
	...
	if(substate == SUB_STATE_TURNWINDMILL_0) {
		...
		//local term = obj.sq_GetIntData(SKILL_TURNWINDMILL, 0); // 0. �ٴ���Ʈ ����
		...
		//{
			...
			//
			//local distance = obj.sq_GetIntData(SKILL_TURNWINDMILL, 1); // 1. �������� ���ư��� �Ÿ�
			//
			//local pAttack = sq_GetCurrentAttackInfo(obj);			
			//local attackRate = obj.sq_GetBonusRateWithPassive(SKILL_TURNWINDMILL STATE_TURNWINDMILL, 0, 1.0); //0.���ݷ�(%)
			//local term = obj.sq_GetIntData(SKILL_TURNWINDMILL, 0); // 0. �ٴ���Ʈ ����
...
//
			//local dirFiringSwitch = obj.sq_GetIntData(SKILL_TURNWINDMILL, 3);// 3. ũ�δ�ũ�� ���� ���� ���ù߻� on/off����ġ
			//
			//if(dirFiringSwitch)
			//{
...
//
		...
		// SUB_STATE_TURNWINDMILL_2 ���꽺����Ʈ �۾�
	}
	else if(substate == SUB_STATE_TURNWINDMILL_3) {
		// SUB_STATE_TURNWINDMILL_3 ���꽺����Ʈ �۾�
	}
	else if(substate == SUB_STATE_TURNWINDMILL_4) {
		// SUB_STATE_TURNWINDMILL_4 ���꽺����Ʈ �۾�
	}
...
function prepareDraw_TurnWindmill(obj)
{
	...
	if(substate == SUB_STATE_TURNWINDMILL_0) {
		// SUB_STATE_TURNWINDMILL_0 ���꽺����Ʈ �۾�
	}
	else if(substate == SUB_STATE_TURNWINDMILL_1) {
		// SUB_STATE_TURNWINDMILL_1 ���꽺����Ʈ �۾�
	}
	else if(substate == SUB_STATE_TURNWINDMILL_2) {
		// SUB_STATE_TURNWINDMILL_2 ���꽺����Ʈ �۾�
	}
...
function onEndCurrentAni_TurnWindmill(obj)
{
	...
	local maxCnt = obj.sq_GetIntData(SKILL_TURNWINDMILL, 2); // 2. ������ ǳ������
