...
//BrokenArrow_state_1 <- 11
	...
	if(passiveState == BrokenArrow_state_0)
	{
		...
		local fireT = 200;
		local srcX = obj.getVar("dis").get_vector(BrokenArrow_START_X); // ����x
		local srcY = obj.getVar("dis").get_vector(BrokenArrow_START_Y); // ����y
		local srcZ = obj.getVar("dis").get_vector(BrokenArrow_START_Z); // ����z
		    	
		local dis_x_len = obj.getVar("dis").get_vector(BrokenArrow_MOV_X); // �� �̵��Ÿ�
		local dis_y_len = obj.getVar("dis").get_vector(BrokenArrow_MOV_Y); // y�� �̵��Ÿ�
		local endZ = obj.getVar("dis").get_vector(BrokenArrow_MOV_Z); // z�� �̵��Ÿ�
