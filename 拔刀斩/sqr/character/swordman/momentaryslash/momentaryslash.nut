function onSetState_swordman_momentaryslashre(obj, state, datas, isResetTimer) {
	...
	if (subState == 0) {
		obj.sq_SetCurrentAnimation(122);//编号是根据character/swordman/swordman.chr 文件的[etc motion]标签中的序号进行排序
...
function onProcCon_swordman_momentaryslashre(obj) {
	...
	local ani = obj.getCurrentAnimation();//getCurrentAnimation()?��?��???��
	local frameIndex = -1;
	// ��ʥ������۰���������?�����???�������������GetCurrentFrameIndex۰��???
